...
const getHelperText = (energyConsumption: number, energyProduction: number) => {
  ...
  if (delta < -7)
    return "У вас сильно не хватает электричества. Рекомендуем купить электростанцию.";

  if (delta >= -7 && delta < -3)
    return "У вас не хватает электроэнергии. Рекомендуем купить электростанцию или внимательно докупать электричество.";

  if (delta >= -3 && delta < -0.5)
    return "У вас немного не хватает электричества. Рекомендуем докупать его самостоятельно.";

  if (delta >= -0.5 && delta <= 0.5)
    return "Ваше среднее энергопотребление сбалансировано. Рекомендуем внимательно пользоваться накопителем.";

  if (delta > 0.5 && delta < 3)
    return "У вас могут образовываться излишки электроэнергии. Рекомендуем вовремя их продавать.";
